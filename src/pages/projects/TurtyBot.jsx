import AboutSection from "../../components/turtybot/AboutSection";
import DefaultTurtyBotSection from "../../components/turtybot/DefaultTurtyBotSection";
...
export default function TurtyBot() {
    return (
        <>
            <AboutSection/>
